...
<html lang="en">
  ...
  <body>
    ...
    <h1>Data Penyewa</h1>
    <a class="btn btn-primary" href="Form_Sewa.php" role="button">Tambah Sewa</a>
        <table class="table">
            <thead>
                <tr>
                <th scope="col">No</th>
            ...
            <tbody>
                ...
                <?php
                    ...
                    while($row=mysqli_fetch_array($query)){
                        ...
                        echo "<td><a href='Form_Edit_Sewa.php?id=$row[id]'>Edit</a>
                                  <a href='Delete_Sewa.php?id=$row[id]'>Delete</a>
                              </td>";
